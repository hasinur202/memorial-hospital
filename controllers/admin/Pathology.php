...
class Pathology extends Admin_Controller {
    ...
    public function pathologyReport() {
        ...
        if (empty($search_type)) {
            ...
            $resultlist = $this->report_model->searchPharmacyReport($select, $join, $table_name, $search_type, $patient_type, $search_table, $search_column, $patient_column, $where = array());
        }
