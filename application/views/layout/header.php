...
<html <?php //echo $this->customlib->getRTL();     ?>>
    <head>
        ...
        <title>Khandakar Memorial Hospital</title>       
       <!--  <title><?php echo $this->customlib->getAppName(); ?></title>     -->
        <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
        <meta name="theme-color" content="#5190fd" />
        <link href="<?php echo base_url(); ?>backend/images/0mini_logo.png" rel="shortcut icon" type="image/x-icon">
            ...
            <div class="topaleart">
                <div class="slidealert">
                    <div class="alert alert-dismissible topaleart-inside">
                        ...
                        <p class="palert">Alert! You are using unregistered version of Khandakar Memorial Hospital. Please <a  href="#" class="purchasemodal">click here</a> to register your purchase code for Khandakar Memorial Hospital.</p>
                    </div></div>
            </div>
            <?php
        }
