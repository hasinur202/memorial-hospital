...
class Report_model extends CI_Model {
    ...
    public function searchSpecificReport($select, $join = array(), $table_name, $search_type, $patient_type, $search_table, $search_column, $patient_column, $additional_where = array()) {
        if ($search_type == 'period') {
            $this->form_validation->set_rules('date_from', $this->lang->line('date_from'), 'trim|required|xss_clean');
            $this->form_validation->set_rules('date_to', $this->lang->line('date_to'), 'trim|required|xss_clean');
            if ($this->form_validation->run() == FALSE) {
                ...
                if($patient_type == 'all'){
                    ...
                    $where = array($search_table . "." . $search_column . " >=  '" . $date_from . "' ", $search_table . "." . $search_column . " <=  '" . $date_to . "'",$search_table . "." . $patient_column . "='" . $patient_type . "'");
                }
            }
        } else if ($search_type == 'today') {
            $today = strtotime('today 00:00:00');
            $first_date = date('Y-m-d H:i:s', $today);
            $where = array($search_table . "." . $search_column . " = '" . $first_date . "'");
            $where = array($search_table . "." . $patient_column . "='" . $patient_type . "'");
        } else if ($search_type == 'this_week') {
            $this_week_start = strtotime('-1 week monday 00:00:00');
            $this_week_end = strtotime('sunday 23:59:59');
            ...
            if($patient_type == 'all'){
                ...
                $where = array($search_table . "." . $search_column . " >= '" . $first_date . "'", $search_table . "." . $search_column . "<= '" . $last_date . "'", $search_table . "." . $patient_column . "='" . $patient_type . "'");
            }
        } else if ($search_type == 'last_week') {
            $last_week_start = strtotime('-2 week monday 00:00:00');
            $last_week_end = strtotime('-1 week sunday 23:59:59');
            ...
            if($patient_type == 'all'){
                ...
                $where = array("year(" . $search_table . "." . $search_column . ") = '" . $search_year . "'", $search_table . "." . $patient_column . "='" . $patient_type . "'");
            }
        } else if ($search_type == 'all time') {
            $where = array();
        }
