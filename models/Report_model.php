...
class Report_model extends CI_Model {
    ...
    public function searchPharmacyReport($select, $join = array(), $table_name, $search_type, $patient_type, $search_table, $search_column, $patient_column, $additional_where = array()) {
