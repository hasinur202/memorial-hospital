                        ...
                        <table class="table table-striped table-bordered table-hover test_ajax" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th ><?php echo $this->lang->line('pharmacy') . " " . $this->lang->line('stock'); ?></th>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <small class="req"> *</small> 
                                        <input type="number" name="packing_qty" class="form-control">
...
<div class="modal fade" id="stockTransferModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="box-title"><?php echo $this->lang->line('add') . " " . $this->lang->line('medicine') . " " . $this->lang->line('in') . " " . $this->lang->line('pharmacy'). " " . $this->lang->line('stock'); ?></h4> 
            </div>
            <div class="modal-body pt0 pb0">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 paddlr">
                        <form id="formstockpharmacy"  accept-charset="utf-8"  method="post" class="ptt10" >
                            <!-- <input type="hidden" name="pharmacy_id" id="pharm_id" > -->
                            <div class="row">
                                <div class="col-sm-8">
                                    <div class="form-group">
            ...
            <div class="box-footer">
                <div class="pull-right">
                    <button type="submit" id="formstockpharmacybtn" data-loading-text="<?php echo $this->lang->line('processing') ?>" class="btn btn-info pull-right"><?php echo $this->lang->line('save'); ?></button>
                    </form>  
                </div>
            </div>
        </div>
...
<div class="modal fade" id="stockPendingModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="box-title"><?php echo $this->lang->line('pending') . " " . $this->lang->line('status'); ?></h4> 
            </div>
            <div class="modal-body pt0 pb0">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 paddlr">
...
<script type="text/javascript">
            ...
            /*	$(document).ready(function (e) {
             ...
             $(document).ready(function (e) {
                $("#formstockpending").on('submit', (function (e) {
                    e.preventDefault();
                    $("#formstockpendingbtn").button('loading');
                    $.ajax({
                        url: '<?php echo base_url(); ?>admin/pharmacy/stockpending',
                        type: "POST",
                        data: new FormData(this),
                        dataType: 'json',
                        contentType: false,
                        ...
                        success: function (data) {
                            ...
                            $("#formstockpendingbtn").button('reset');
                        },
                        error: function () {
                            //  alert("Fail")
                        }
             ...
             $(document).ready(function (e) {
                $("#formstockpharmacy").on('submit', (function (e) {
                    e.preventDefault();
                    $("#formstockpharmacybtn").button('loading');
                    $.ajax({
                        url: '<?php echo base_url(); ?>admin/pharmacy/stocktransfer',
                        type: "POST",
                        data: new FormData(this),
                        dataType: 'json',
                        contentType: false,
                        ...
                        success: function (data) {
                            if (data.status == "fail") {
                                var message = "Required quantity not available in main stock";
                                $.each(data.error, function (index, value) {
                                    message += value;
                                });
                                errorMsg(message);
                            ...
                            $("#formstockpharmacybtn").button('reset');
                        },
                        error: function () {
                            //  alert("Fail")
                        }
