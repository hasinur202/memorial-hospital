            ...
            <div class="col-md-12">
                <div class="">
                        <div class="pprinta4">
                            ...
                            <h4 style="text-align: center;font-weight:bold;">Khandakar Hospital</h4>
                            <p style="text-align:center;">Mobile: <strong>01773-757115</strong><br>Sadar Hospital Road, Gaibandha</p>
                        </div>
...
<!--                         <tr>
            ...
            <td><?php echo $currency_symbol . "" . $result["total"]; ?></td>
                    ...
                    <hr style="height: 1px; clear: both;margin-bottom: 10px; margin-top: 10px"> 
                    <span style="text-align: center; margin-top: 10px;">Developed by www.ideatechsolution.com</span>
