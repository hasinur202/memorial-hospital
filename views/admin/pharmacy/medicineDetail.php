                ...
                <table class="table table-striped table-bordered table-hover example" id="detail" cellspacing="0" width="100%" >
                    <thead>
                        <tr>
                            ...
                            <th class="text-right"><?php echo $this->lang->line('purchase'). " " . $this->lang->line('qty'); ?></th>
                            ...
                            <th class="text-right"><?php echo $this->lang->line('total'). " " . $this->lang->line('stock'). " " . $this->lang->line('qty'); ?></th>
                    ...
                    <tbody>
                        ...
                        foreach ($result as $detail) {
                            ...
                            <tr>
                                ...
                                <td class="text-right"><?php echo $detail->stock; ?></td>

                                <td class="text-right"><?php if ($this->rbac->hasPrivilege('add_medicine_stock', 'can_delete')) { ?>
                                    <a href="#" class="btn btn-default btn-xs" data-toggle="tootip" title="<?php echo $this->lang->line('delete'); ?>" onclick="delete_batch('<?php echo $detail->id ?>', '<?php echo $detail->pharmacy_id ?>')"><i class="fa fa-trash"></i></a>
                                <?php } ?>
