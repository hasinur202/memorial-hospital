                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="tableID">
                                            ...
                                            <tr id="row0">
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    <!-- me -->
                                                        <input type="hidden" name="purchase_price[]" onchange="multiply(0)" id="purchase_price0" placeholder="" class="form-control text-right">
                                                        <input type="hidden" name="total_purchase[]" id="total_purchase0" placeholder="" class="form-control text-right">
                                            ...
                                            <table class="printablea4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2" class="text-right ipdbilltable">
                                                        ...
                                                        <input type="hidden" placeholder="Net Amount" value="0" name="net_purchase" id="net_purchase" style="width: 30%; float: right" class="form-control"/>
        ...
        if (batch_no != "") {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    //me
                    $('#purchase_price' + id).val(data.purchase_price);
                }
            });
        }
    }
...
//       $('#batch_no' + rowid).select2("val", 'l');
    ...
    function multiply(id) {
        ...
        $('#total_purchase' + id).val(total_purchase);
